...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // アニメーション対象の要素を監視
  const animatedElements = document.querySelectorAll('.project-card, .skill-group, .stat-card, .timeline-item, .tech-card, .flow-step, .why-card, .biz-card, .constraint-card, .card-base, .fade-up');
